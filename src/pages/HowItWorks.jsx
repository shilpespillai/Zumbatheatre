  ...
  return (
    <div className="min-h-screen bg-zumba-dark text-white font-sans overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none opacity-30">
        ...
        <div className="absolute top-1/2 right-0 w-[800px] h-[800px] bg-zumba-lime/10 blur-[150px] rounded-full translate-x-1/2 -translate-y-1/2" />
        <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-zumba-cyan/10 blur-[120px] rounded-full -translate-x-1/2 translate-y-1/2" />
      </div>
      ...
      <div className="relative z-10">
        ...
        <nav className="p-8 max-w-7xl mx-auto flex justify-between items-center">
            <a href="/" className="flex items-center gap-2 group">
                <div className="w-10 h-10 bg-zumba-pink rounded-xl flex items-center justify-center rotate-12 group-hover:rotate-0 transition-transform">
                    <Play className="w-6 h-6 text-white fill-current" />
                </div>
                <span className="text-xl font-black tracking-tighter">ZUMBA<span className="text-zumba-lime">THEATRE</span></span>
            </a>
        ...
        <section className="py-24 px-6 max-w-7xl mx-auto">
           <div className="flex flex-col lg:flex-row gap-20 items-center mb-20">
              <div className="flex-1 space-y-8">
                <div className="inline-flex items-center gap-3 bg-zumba-pink/10 border border-zumba-pink/20 px-6 py-2 rounded-full">
                    <Users className="w-5 h-5 text-zumba-pink" />
                    <span className="text-sm font-black uppercase tracking-widest text-zumba-pink">For Instructors</span>
                </div>
        ...
        <section className="py-32 px-6 max-w-7xl mx-auto">
           <div className="flex flex-col lg:flex-row-reverse gap-20 items-center">
              <div className="flex-1 space-y-8">
                <div className="inline-flex items-center gap-3 bg-zumba-lime/10 border border-zumba-lime/20 px-6 py-2 rounded-full">
                    <Star className="w-5 h-5 text-zumba-lime" />
                    <span className="text-sm font-black uppercase tracking-widest text-zumba-lime">For Dancers</span>
                </div>
        ...
        <section className="py-40 px-6 text-center">
            ...
            >
                ...
                <div className="flex flex-col sm:flex-row gap-6 justify-center">
                    ...
                    <a href="/auth?role=student" className="btn-premium bg-zumba-lime text-black text-lg py-5 px-10 rounded-2xl flex items-center gap-3 justify-center">
