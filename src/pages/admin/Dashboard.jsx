      ...
      <div className="max-w-6xl mx-auto">
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center mb-16 gap-6">
          <div className="flex items-center gap-6">
            <div className="w-16 h-16 rounded-[2rem] bg-theatre-dark flex items-center justify-center rotate-6 shadow-xl shadow-theatre-dark/20">
              <ShieldCheck className="text-white w-8 h-8" />
            </div>
            <div>
              <h1 className="text-4xl font-black text-theatre-dark tracking-tight">Stage Control Center</h1>
              <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-theatre-dark/40 mt-1">Global System Administration</p>
            </div>
          </div>
          <button onClick={signOut} className="p-4 bg-white rounded-2xl border border-theatre-dark/10 hover:bg-rose-petal/5 transition-all shadow-sm">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <section className="bg-white/80 p-10 rounded-[3.5rem] border border-apricot/40 shadow-2xl shadow-rose-bloom/5">
              <div className="flex items-center gap-4 mb-10">
                ...
                <div>
                  ...
                  <p className="text-xs font-bold text-theatre-dark/40 uppercase tracking-widest mt-1">Manage Platform Fees</p>
                </div>
              </div>
              ...
              <form onSubmit={handleSave} className="space-y-8">
                <div className="space-y-4">
                  <div className="flex justify-between items-center ml-2">
                    <label className="text-xs font-black uppercase tracking-widest text-theatre-dark/40">Monthly Pro Subscription</label>
                  ...
                  <div className="relative group">
                    ...
                    <input 
                      ...
                      className="w-full bg-bloom-white border border-apricot/40 rounded-2xl py-6 pl-14 pr-6 focus:outline-none focus:border-rose-bloom transition-all font-black text-2xl text-theatre-dark"
                      placeholder="49.00"
                      required
                    />
                  </div>
                  <p className="text-[10px] text-theatre-dark/30 ml-2 italic">
                ...
                <button 
                  type="submit" 
                  disabled={saving}
                  className="w-full btn-premium bg-theatre-dark text-white py-6 rounded-[2rem] flex items-center justify-center gap-3 shadow-xl hover:bg-rose-bloom transition-all"
                >
            ...
            <div className="p-10 bg-rose-petal/5 rounded-[3rem] border border-rose-petal/10">
               ...
               <div className="grid grid-cols-2 gap-6">
                  <div className="bg-white p-6 rounded-2xl border border-apricot/20">
                     ...
                     <div className="text-[8px] font-black uppercase text-theatre-dark/30 mb-1">Total Revenue</div>
                     <div className="text-2xl font-black">$24,490</div>
                  </div>
                  <div className="bg-white p-6 rounded-2xl border border-apricot/20">
                     <Users className="w-6 h-6 text-rose-bloom mb-4" />
                     <div className="text-[8px] font-black uppercase text-theatre-dark/30 mb-1">Active Teachers</div>
          ...
          <aside className="space-y-8">
            <div className="p-10 bg-gradient-to-br from-theatre-dark to-[#2A2426] rounded-[3rem] text-white shadow-2xl relative overflow-hidden">
            ...
            <div className="p-10 bg-white rounded-[3rem] border border-apricot/40 shadow-sm">
               ...
               <div className="space-y-4">
                  <button className="w-full py-4 px-6 bg-bloom-white rounded-xl text-[10px] font-black uppercase tracking-widest text-theatre-dark text-left hover:bg-apricot/10 transition-colors border border-apricot/20">Review New Teachers</button>
                  <button className="w-full py-4 px-6 bg-bloom-white rounded-xl text-[10px] font-black uppercase tracking-widest text-theatre-dark text-left hover:bg-apricot/10 transition-colors border border-apricot/20">Audit Payment Logs</button>
               </div>
            </div>
          </aside>
        </div>
